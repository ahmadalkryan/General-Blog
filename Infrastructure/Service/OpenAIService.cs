...
//        {
//            var apiUrl = "https://api-inference.huggingface.co/models/google/flan-t5-large";
//            var messages = new[]
//         {
//            new
//            {
//                role = "system",
//                content = @"أنت مساعد ذكي لمدونة انكليزية. قم بالإجابة على أسئلة القراء بناءً على المحتوى المقدم فقط.
...
//            {
//                role = "system",
//                content = @"قم بتلخيص النص في نقاط رئيسية واضحة  باللغة الانكليزية.
...
//            try
//            {
//                var response = await _httpClient.GetAsync("https://api-inference.huggingface.co/models/google/flan-t5-large");
